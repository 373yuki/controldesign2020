...
## interactorを定義
def update(k=0.1, alpha=1, T1=0.1, beta=0.9, T2=1):
    #G = G2 * tf([1],[T3, 1])
    C = k * tf([alpha*T1, alpha], [alpha*T1, 1]) * tf([T2, 1], [beta*T2, 1]) 
    Gyr = feedback(G*C, 1)
...
## interactorの実行
interact(update, k = (0.1, 10, 0.05), alpha = (1, 1000, 10), T1 = (0.1, 10, 0.1), beta = (0, 1, 0.05), T2 = (0.01, 1, 0.01)  )